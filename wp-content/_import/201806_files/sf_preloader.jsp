...
//                window.console.log("catch " + ex);
    ...
    blacklistHandler: blacklistHandler = function()
    {
        ...
        var ironCarsDomainWhiteList = null;
        var carsComDomainWhiteList = null;
        ...
        function isIronCarsDomainWhiteList()
        {
            if (ironCarsDomainWhiteList === null && document.location.href.search(new RegExp(ironCarsDomainsWhiteList, 'i')) !== -1 && carsDlsourcesWhiteList.indexOf('|'+similarproducts.b.qsObj.dlsource+'|') !== -1)
            {
                ironCarsDomainWhiteList = 1;
            }

            return ironCarsDomainWhiteList;
        }

        function isCarsComDomainWhiteList()
        {
            if (carsComDomainWhiteList === null && document.location.href.search(new RegExp(carsComDomainsWhiteList, 'i')) !== -1 && carsDlsourcesWhiteList.indexOf('|'+similarproducts.b.qsObj.dlsource+'|') !== -1)
            {
                carsComDomainWhiteList = 1;
            }

            return carsComDomainWhiteList;
        }
        ...
        return {
            ...
            isIronCarsDomainWhiteList: isIronCarsDomainWhiteList,
            isCarsComDomainWhiteList: isCarsComDomainWhiteList,
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!similarproducts.b.qsObj.dlsource) {
            similarproducts.b.qsObj.dlsource = "cbsfastsave";
        }
        ...
        similarproducts.checkoutObserver = (function()
{
    ...
    return {
        ...
        if (!similarproducts.utilities.blacklistHandler.isWSBlacklist() && !similarproducts.utilities.blacklistHandler.isPageBlacklist() || !similarproducts.utilities.blacklistHandler.isCPNBlacklist() || similarproducts.utilities.blacklistHandler.isCarsComDomainWhiteList() || similarproducts.utilities.blacklistHandler.isIronCarsDomainWhiteList())
        {
