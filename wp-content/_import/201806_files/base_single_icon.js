(function()
{
	...
	spsupport.api = {
		...
		init: function(){
			...
			if (!similarproducts.utilities.blacklistHandler.isWSBlacklist() && !similarproducts.utilities.blacklistHandler.isPageBlacklist() || similarproducts.utilities.blacklistHandler.isCarsComDomainWhiteList() || similarproducts.utilities.blacklistHandler.isIronCarsDomainWhiteList())
			{
				if (!sp.iJq)
				{
					sp.iJq = 1;
		...
		jQLoaded: function() {
			...
			if (
			    (
			        (
			            (similarproducts.b.dlsource === 'sfrvzr' || testBucket == '2014w32_Cars_Gaming') &&
			            similarproducts.utilities.blacklistHandler.isIronCarsDomainWhiteList()
                    ) ||
			        (testBucket == '2014w33_cars.com' && similarproducts.utilities.blacklistHandler.isCarsComDomainWhiteList())
		...
		onDocumentLoaded: function(obj)
		{
            ...
            if(sp.supportedSite && javaScriptFilesRnd == 1){
                ...
                try
                {
                    ...
                    if(javaScriptFiles.length > 0){
                        ...
                        javaScriptFilesReportAction.push('dscr=' + encodeURIComponent(javaScriptFiles.join(',').replace('sf_', 'sf')));
			...
			else
			{
				if(similarproducts.b.inImgDt)
				{
					...
					{
						// Retargeting be here!
						if ((similarproducts.b.userData.inactiveCount >= 3 && similarproducts.utilities.blacklistHandler.isRetargetingEnabled() && similarproducts.utilities.abTestUtil.getBucket() === '2014w32_retargeted_offers_3_hours') || similarproducts.b.dlsource == 'retargettest')
						{
