...
?>
<article  id="post-<?php echo $post->ID; ?>" style="background: #efefef; box-shadow: 0px 0px 3px rgba(0,0,0,.4);" >
	<!-- Head -->
	...
	<div style="padding: 0 20px 20px;">
		<div class='post-header'>
			<h1 class='entry-title'>
				<a href='<?php echo get_permalink(); ?>' title='<?php  _e( "Permalink to", "intense" ); ?>  <?php echo the_title_attribute( 'echo=0' ); ?>' rel='bookmark'><?php echo the_title_attribute( 'echo=0' ); ?></a>
			</h1>
		</div>
		...
		<footer style='padding-top: 5px;'>
			...
			<?php echo intense_run_shortcode( 'intense_button', array( 'size' => 'mini', 'color' => 'link', 'link' => get_permalink(), 'icon' => 'angle-right', 'icon_position' => 'right' ), $intense_custom_post['timeline_readmore'] ); ?>			
			</span>
