...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="entry-content">
		...
		<?php
			if ( get_field( 'intense_project_subtitle' ) != '' ) {
				echo "<h4 style='font-style:italic;'>" . get_field( 'intense_project_subtitle' ) . "</h4>";
			}
		?>
		<div class="intense row" style="padding-top: 0;">
			<div class="intense col-lg-4 col-xs-12 col-sm-12 col-md-4">
				<?php
					$categories = wp_get_post_terms( $post->ID, 'intense_project_category', array("fields" => "all") );
					...
					$skills = wp_get_post_terms( $post->ID, 'intense_project_skills', array("fields" => "all") );
					...
					if ( get_field( 'intense_project_designed_by' ) != '' ) {
						echo __( 'Designed By', 'intense' ) . ": " . get_field( 'intense_project_designed_by' ) . "<br />";
					}

					if ( get_field( 'intense_project_built_by' ) != '' ) {
						echo __( 'Built By', 'intense' ) . ": " . get_field( 'intense_project_built_by' ) . "<br />";
					}

					if ( get_field( 'intense_project_produced_by' ) != '' ) {
						echo __( 'Produced By', 'intense' ) . ": " . get_field( 'intense_project_produced_by' ) . "<br />";						
					}
				?>
			</div>
