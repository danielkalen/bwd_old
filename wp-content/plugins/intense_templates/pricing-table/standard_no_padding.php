<?php
/*
Intense Template Name: Standard (no padding)
*/
...
<div class="intense pricing-table-section pricing-table-standard_no_padding" style="<?php echo $background_color_css . $font_color_css . $borders; ?> text-align: center;">
