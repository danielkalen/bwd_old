...
<div class="intense pricing-table-section pricing-table-pricing" style="<?php echo $background_color_css . $font_color_css . $borders . $padding; ?> text-align: center;">
	<h2 style="<?php echo $font_color_css; ?>"><?php echo $intense_pricing_section['title'] . $amount; ?></h2>
