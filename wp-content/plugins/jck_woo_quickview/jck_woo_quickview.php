...
/* 	=== Frontend Function ===  */
	...
	public function quickviewModal(){
		...
		echo '<div id="'.$this->slug.'" class="cf woocommerce">';
		
			include($this->plugin_path.'/inc/qv-images.php');
			
			echo '<div id="'.$this->slug.'_summary"><div class="summary entry-summary">';
...
/* 	=============================
	...
	public function register_scripts_and_styles() {
		...
		if ( is_admin() ) {
			...
			// $this->load_file( 'dt-modernizer', '../../themes/dt-the7/js/modernizr.js', true );
			$this->load_file( $this->slug . '-script', '../../themes/dt-the7/js/main_js_only.bak.min.js', true );
