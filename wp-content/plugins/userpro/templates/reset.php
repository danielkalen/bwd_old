<div class="userpro userpro-<?php echo $i; ?> userpro-<?php echo $layout; ?>" <?php userpro_args_to_data( $args ); ?>>
	...
	<div class="userpro-body">
		...
		<form action="" method="post" data-action="<?php echo $template; ?>">
			...
			<!-- fields -->
			<div class='userpro-field userpro-field-user_email' data-key='username_or_email'>
				<div class='userpro-input'>
					<input type='text' placeholder="Email Address" name='username_or_email-<?php echo $i; ?>' id='username_or_email-<?php echo $i; ?>' />
				</div>
			</div>
