...
class ITSEC_Database_Prefix_Admin {
	...
	public function dashboard_status( $statuses ) {
		...
		if ( $this->settings !== true ) {
			...
			$status       = array( 'text' => sprintf( '%s wp_.', __( 'Your database table prefix is not using', 'it-l10n-ithemes-security-pro' ) ), 'link' => '#itsec_change_table_prefix', 'advanced' => true, );

		} else {

			$status_array = 'medium';
			$status       = array( 'text' => sprintf( '%s wp_.', __( 'Your database table prefix should not be', 'it-l10n-ithemes-security-pro' ) ), 'link' => '#itsec_change_table_prefix', 'advanced' => true, );
