...
class ITSEC_Four_Oh_Four_Admin {
	...
	public function dashboard_status( $statuses ) {
		...
		if ( $this->settings['enabled'] === true ) {
			...
			$status       = array( 'text' => __( 'Your site is protecting against bots looking for known vulnerabilities.', 'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_four_oh_four_enabled', );

		} else {

			$status_array = 'medium';
			$status       = array( 'text' => __( 'Your website is not protected against bots looking for known vulnerabilities. Consider turning on 404 protection.', 'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_four_oh_four_enabled', );
	...
	public function check_period() {
		...
		$content .= '<p class="description"> ' . __( 'The number of minutes in which 404 errors should be remembered and counted towards lockouts.', 'it-l10n-ithemes-security-pro' ) . '</p>';
	...
	public function error_threshold() {
		...
		$content .= '<p class="description"> ' . __( 'The numbers of errors (within the check period time frame) that will trigger a lockout. Set to zero (0) to record 404 errors without locking out users. This can be useful for troubleshooting content or other errors. The default is 20.', 'it-l10n-ithemes-security-pro' ) . '</p>';
	...
	public function logs_metabox() {
		...
		echo __( 'Below is a summary log of all the 404 errors on your WordPress site. To get details on a particular item click the title. To adjust logging options visit the global settings page.', 'it-l10n-ithemes-security-pro' );
	...
	public function white_list() {
		...
		$content .= '<p class="description">' . __( 'Use the whitelist above to prevent recording common 404 errors. If you know a common file on your site is missing and you do not want it to count towards a lockout record it here. You must list the full path beginning with the "/"', 'it-l10n-ithemes-security-pro' ) . '</p>';
