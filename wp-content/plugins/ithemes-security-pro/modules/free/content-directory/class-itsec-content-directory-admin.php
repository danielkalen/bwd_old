...
class ITSEC_Content_Directory_Admin {
	...
	public function dashboard_status( $statuses ) {
		...
		if ( $this->settings === true ) {
			...
			$status       = array( 'text' => __( 'You have renamed the wp-content directory of your site.', 'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_enable_content_dir', 'advanced' => true, );

		} else {

			$status_array = 'low';
			$status       = array( 'text' => __( 'You should rename the wp-content directory of your site.', 'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_enable_content_dir', 'advanced' => true, );
