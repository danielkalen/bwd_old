...
class ITSEC_Admin_User_Admin {
	...
	public function dashboard_status( $statuses ) {
		...
		if ( ! username_exists( 'admin' ) ) {
			...
			$status       = array( 'text' => __( 'The <em>admin</em> user has been removed or renamed.', 'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_authentication_admin_user_username', 'advanced' => true, );

		} else {

			$status_array = 'high';
			$status       = array( 'text' => __( 'The <em>admin</em> user still exists.', 'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_authentication_admin_user_username', 'advanced' => true, );
		...
		if ( ! ITSEC_Lib::user_id_exists( 1 ) ) {
			...
			$status       = array( 'text' => __( 'The user with id 1 has been removed.', 'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_authentication_admin_user_userid', 'advanced' => true, );

		} else {

			$status_array = 'medium';
			$status       = array( 'text' => __( 'A user with id 1 still exists.', 'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_authentication_admin_user_userid', 'advanced' => true, );
