...
class ITSEC_File_Change_Admin {
	...
	public function dashboard_status( $statuses ) {
		...
		if ( $this->settings['enabled'] === true ) {
			...
			$status       = array( 'text' => __( 'Your site will detect changes to your files.', 'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_file_change_enabled', );

		} else {

			$status_array = 'medium';
			$status       = array( 'text' => __( 'Your website is not looking for changed files. Consider turning on file change detections.', 'it-l10n-ithemes-security-pro' ), 'link' => '#itsec_file_change_enabled', );
	...
	public function logs_metabox() {
		...
		echo __( 'Below is a summary log of all the file changes recorded for your WordPress site. To get details on a particular item click the title. To adjust logging options visit the global settings page.', 'it-l10n-ithemes-security-pro' );
