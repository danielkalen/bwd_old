...
class ITSEC_Backup_Admin {
	...
	public function admin_script() {
		...
		if ( isset( get_current_screen()->id ) && strpos( get_current_screen()->id, 'security_page_toplevel_page_itsec_settings' ) !== false ) {
			...
			wp_localize_script( 'itsec_backup_js', 'exclude_text', array( 'available' => __( 'Tables for Backup', 'it-l10n-ithemes-security-pro' ), 'excluded' => __( 'Excluded Tables', 'it-l10n-ithemes-security-pro' ) ) );
	...
	public function location() {
		...
		$content .= '<label for="itsec_backup_location"> ' . __( 'The path on your machine where backup files should be stored.', 'it-l10n-ithemes-security-pro' ) . '</label>';
		$content .= '<p class="description"> ' . __( 'This path must be writable by your website. For added security, it is recommended you do not include it in your website root folder.', 'it-l10n-ithemes-security-pro' ) . '</p>';
