...
<li>
	...
	<ul>
		...
		<li><?php _e( 'MySQL Client Version', 'it-l10n-ithemes-security-pro' ); ?>:
		...
		if ( empty( $sql_mode ) )
			$sql_mode = __( 'Not Set', 'it-l10n-ithemes-security-pro' ); else $sql_mode = __( 'Off', 'it-l10n-ithemes-security-pro' );
		?>
...
<li>
	...
	<ul>
		...
		?>
		<li><?php _e( 'PHP Register Globals', 'it-l10n-ithemes-security-pro' ); ?>:
		...
		?>
		<li><?php _e( 'PHP Magic Quotes GPC', 'it-l10n-ithemes-security-pro' ); ?>:
...
<li>
	...
	<ul>
		<li><?php _e( 'Build Version', 'it-l10n-ithemes-security-pro' ); ?>:
