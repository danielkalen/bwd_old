...
if ( ! class_exists( 'ITSEC_Core' ) ) {
	...
	final class ITSEC_Core {
		...
		function __construct( $plugin_file, $plugin_name ) {
			...
			load_plugin_textdomain( 'it-l10n-ithemes-security-pro', false, $itsec_globals['plugin_dir'] . '/lang' );
