...
final class ITSEC_Logger {
	...
	public function add_admin_meta_boxes() {
		...
		add_meta_box(
			'itsec_log_header',
			__( 'Security Logs', 'it-l10n-ithemes-security-pro' ),
		...
		add_meta_box(
			'itsec_log_all',
			__( 'All Logged Items', 'it-l10n-ithemes-security-pro' ),
	...
	public function metabox_all_logs() {
		...
		echo __( 'Below is the log of all the log items in your WordPress Database. To adjust logging options visit the global settings page.', 'it-l10n-ithemes-security-pro' );
